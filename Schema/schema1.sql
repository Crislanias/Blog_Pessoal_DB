...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_postagens` (
  ...
  `data` DATE NULL,
  `tema_id BIGINT` VARCHAR(45) NULL,
  `usuario_id BIGINT` VARCHAR(45) NULL,
  `tb_temas_id BIGINT` INT NOT NULL,
  `tb_usuarios_id BIGINT` INT NOT NULL,
  PRIMARY KEY (`id BIG`),
  INDEX `fk_tb_postagens_tb_temas_idx` (`tb_temas_id BIGINT` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tb_postagens_tb_temas`
    ...
    REFERENCES `db_blog_pessoal`.`tb_temas` (`id BIGINT`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
